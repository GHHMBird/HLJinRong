...
import com.haili.finance.user.adapter.PastRedPacketAdapter;
...
public class PastRedPacketFragment extends BaseFragment {
private Subscription subscrip;
    private RecyclerView recyclerView;
    private MyLayoutManager myLayoutManager;
    private PastRedPacketAdapter adapter;
    ...
    public PastRedPacketFragment(int getType){
        type = getType;
    }
    ...
    private void setAdapter() {
        if (redPackageArrayList != null && redPackageArrayList.size() > 0) {
            adapter = new PastRedPacketAdapter(PastRedPacketFragment.this, getActivity(), redPackageArrayList);
