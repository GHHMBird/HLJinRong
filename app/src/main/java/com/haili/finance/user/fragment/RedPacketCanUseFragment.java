...
import com.haili.finance.user.adapter.RedPacketCanUseAdapter;
...
public class RedPacketCanUseFragment extends BaseFragment {
private Subscription subscrip;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView loadingFailImage = (ImageView) view.findViewById(R.id.loading_fail_image);
    ...
    private void initCacheData() {
        GetRedPackageResponse cacheData = DataCache.instance.getCacheData("haili", "GetRedPackageResponse1");
        if (cacheData == null) {
            return;
        }
                ...
                .subscribe(new Action1<GetRedPackageResponse>() {
                    ...
                    public void call(GetRedPackageResponse getRedPackageResponse) {
                        ...
                        if (getRedPackageResponse.dataModel != null) {
                            if (pageIndex == 1) {
                                DataCache.instance.saveCacheData("haili", "GetRedPackageResponse1", getRedPackageResponse);
                    ...
                    public void call(Throwable throwable) {
                        ...
                        if (DataCache.instance.getCacheData("haili", "GetRedPackageResponse1") != null) {
                            frameLayout.setVisibility(View.GONE);
    ...
    private void setAdapter(GetRedPackageResponse getRedPackageResponse, int type) {
        ...
        if (dataModel != null && dataModel.size() > 0) {
            switch (type) {
                case 0:
                    adapter = new RedPacketCanUseAdapter(RedPacketCanUseFragment.this, dataModel);
            ...
            adapter.setOnClickDoneListener(new RedPacketCanUseAdapter.OnClickDoneListener() {
                @Override
