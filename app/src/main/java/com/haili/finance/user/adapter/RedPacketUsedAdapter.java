...
public class RedPacketUsedAdapter extends RecyclerView.Adapter<RedPacketUsedAdapter.ViewHolder> {
    ...
    public RedPacketUsedAdapter(Fragment fragment, Context context, ArrayList<GetRedPackageModel> list) {
