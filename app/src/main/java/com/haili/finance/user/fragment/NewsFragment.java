...
import com.haili.finance.user.adapter.NewsAdapter;
...
public class NewsFragment extends BaseFragment {
    ...
    private void initCacheData() {
        NewsNoticeResponse cacheData = DataCache.instance.getCacheData("haili", "NewsNoticeResponse2");
        if (cacheData == null) {
            return;
        }
                ...
                .subscribe(new Action1<NewsNoticeResponse>() {
                    ...
                    public void call(NewsNoticeResponse newsNoticeResponse) {
                        ...
                        if (newsNoticeResponse.dataModel != null) {
                            if (pageIndex == 1) {
                                DataCache.instance.saveCacheData("haili", "NewsNoticeResponse2", newsNoticeResponse);
                    ...
                    public void call(Throwable throwable) {
                        ...
                        if (DataCache.instance.getCacheData("haili", "NewsNoticeResponse2") != null) {
                            frameLayout.setVisibility(View.GONE);
    ...
    public void analyseData(NewsNoticeResponse newsNoticeResponse, int type) {
        ...
        if (dataModel.size() > 0) {
            switch (type) {
                case 0:
                    newsAdapter = new NewsAdapter(getActivity(), dataModel);
                    recyclerView.setAdapter(newsAdapter);
                    break;
                case 1:
                    newsAdapter.addData(dataModel);
                    break;
                case 2:
                    if (newsAdapter == null) {
                        newsAdapter = new NewsAdapter(getActivity(), dataModel);
