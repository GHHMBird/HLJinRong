...
import com.haili.finance.user.fragment.PastRedPacketFragment;
...
public class PastRedPacketAdapter extends RecyclerView.Adapter<PastRedPacketAdapter.ViewHolder>{

    private PastRedPacketFragment fragment;
    private ArrayList<GetRedPackageModel> list;

    private int redPacketType = 0;
    private Context context;

    public PastRedPacketAdapter(PastRedPacketFragment fragment, Context context, ArrayList<GetRedPackageModel> list) {
    ...
    @Override
    public PastRedPacketAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(fragment.getActivity()).inflate(R.layout.item_redbackpage, null);
        return new PastRedPacketAdapter.ViewHolder(v);
    }
