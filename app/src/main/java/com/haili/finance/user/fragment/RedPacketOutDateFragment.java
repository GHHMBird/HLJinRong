...
import com.haili.finance.user.adapter.RedPacketOutDateAdapter;
...
public class RedPacketOutDateFragment extends BaseFragment {
private Subscription subscrip;
    private RecyclerView recyclerView;
    private MyLayoutManager myLayoutManager;
    private RedPacketOutDateAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView failLoading = (ImageView) view.findViewById(R.id.loading_fail_image);
    ...
    private void initCacheData() {
        GetRedPackageResponse cacheData = DataCache.instance.getCacheData("haili", "GetRedPackageResponse3");
        if (cacheData == null) {
            return;
        }
                ...
                .subscribe(new Action1<GetRedPackageResponse>() {
                    ...
                    public void call(GetRedPackageResponse getRedPackageResponse) {
                        ...
                        if (getRedPackageResponse.dataModel != null) {
                            if (pageIndex == 1) {
                                DataCache.instance.saveCacheData("haili", "GetRedPackageResponse3", getRedPackageResponse);
                    ...
                    public void call(Throwable throwable) {
                        ...
                        if (DataCache.instance.getCacheData("haili", "GetRedPackageResponse3") != null) {
                            frameLayout.setVisibility(View.GONE);
    ...
    private void setAdapter(GetRedPackageResponse getRedPackageResponse, int type) {
        ...
        if (dataModel != null && dataModel.size() > 0) {
            switch (type) {
                case 0:
                    adapter = new RedPacketOutDateAdapter(RedPacketOutDateFragment.this, getActivity(), dataModel);
            ...
            adapter.setOnClickDoneListener(new RedPacketOutDateAdapter.OnClickDoneListener() {
                @Override
