...
public class InvestmentRecordAdpter extends BaseAdapter<InvestmentHistoryModel> {

    public InvestmentRecordAdpter(Context context, List<InvestmentHistoryModel> data, int layoutId) {
