...
import com.haili.finance.fragment.TerminalManageFragment;
...
public class ManageAdapter extends RecyclerView.Adapter<ManageAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public ManageAdapter (TerminalManageFragment fragment, Context context){
    ...
    @Override
    public void onBindViewHolder(ManageAdapter.ViewHolder holder, final int position) {
        ...
        holder.tv_state.setOnClickListener(this);
        holder.tv_state2.setOnClickListener(this);
    }
    ...
    public void setOnCheckedListener(OnEditDoneListener onEditDone) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView iv_redPackpage,image,type_icon;
