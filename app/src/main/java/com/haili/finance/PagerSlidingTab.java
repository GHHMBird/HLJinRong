...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFF649613;//指示线的颜色#006BCE
    ...
    private int tabBackgroundResId = Color.TRANSPARENT;//todo 自己设置的背景
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setTextColor(i == 0 ? Color.WHITE : Color.WHITE);//todo 自己设置的文字
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制滚动的背景
        //rectPaint.setColor(/*Color.parseColor("#66006BCE")*/indicatorColor);
        //canvas.drawRect(lineLeft,0, lineRight, height, rectPaint);

        //绘制滚动的圆角背景
        RectF rect = new RectF(lineLeft * 2, 0 + height/4, lineRight, height-height/4);
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setTextColor(i == pager.getCurrentItem() ? getResources().getColor(R.color.green_text) : tabTextColor);
                }
            }
        }
    }
